...
def parse_args():
    ...
    p.add_argument('--model_type', default='llava-hf',
                   choices=['llava-hf', 'llava-liuhaotian'],
...
def main():
    ...
    if args.fig5 or args.all:
        out = os.path.join(args.output_dir,
                           f'fig5_stacked_bar.{args.format}')
    ...
    if args.fig6 or args.all:
        out = os.path.join(args.output_dir,
                           f'fig6_high_confidence.{args.format}')
    ...
    if args.fig7 or args.all and args.data_dirs:
        ...
        if args.data_dirs:
            ...
            out = os.path.join(args.output_dir,
                               f'fig7_cross_model.{args.format}')
    ...
    if args.compare or args.all:
        ...
        if perm_dir and os.path.isdir(perm_dir):
            ...
            if phase4_labels:
                out = os.path.join(args.output_dir,
                                   f'phase3_vs_phase4.{args.format}')
