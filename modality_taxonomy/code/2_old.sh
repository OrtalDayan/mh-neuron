...
# Contrastive filtering (full mode only)
if [[ "$HALLUC_CONTRASTIVE" == "1" && "$MODE" == "full" ]]; then
...
STEERING_OUT="$OUTPUT_DIR/$MODEL_NAME/ablation/steering"
PLOT_OUT_DIR="results/13-plots/${MODE_DIR}/${MODEL_NAME}"
...
PLOT_OUT_DIR="results/13-plots/${MODE_DIR}/${MODEL_NAME}"
MERGED_JSON="$PLOT_OUT_DIR/steering_merged.json"
HALLUC_SCORES_DIR_PLOT="results/10-halluc_scores/${MODE_DIR}/${MODEL_NAME}"
