...
# POPE hallucination signal: binary (default, original) vs logit_margin (dense
# ΔH — fixes the all-zero/tie-break degeneration, esp. for low-baseline models
# like InternVL). Override: HALLUC_MEASURE=logit_margin bash run_pipeline.sh ...
HS_COMMON_ARGS="$HS_COMMON_ARGS --halluc_measure ${HALLUC_MEASURE:-binary}"
