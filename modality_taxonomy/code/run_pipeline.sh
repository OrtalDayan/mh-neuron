...
MODE="full"            # test | full
SHARDS=32              # GPUs
MODEL_TYPE="llava-liuhaotian"    # model backend (llava-liuhaotian / llava-hf / internvl / qwen2vl)
...
ALL_MODELS=(llava-liuhaotian llava-ov internvl qwen2vl)
...
# InternVL / Qwen2VL / LLaVA-OV need modern_vlms/.venv which has compatible versions.
#
...
case "$STEP" in
    ...
    *) echo "ERROR: unknown step '$STEP'"; echo "  Valid: 1-8, all, all_att"; exit 1 ;;
esac
