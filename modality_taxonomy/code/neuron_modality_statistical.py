...
#     # With transformers==4.37.2 the custom config attribute isn't propagated
#     # to the model object, so the forward() check (input_ids == self.img_context_token_id)
#     # gets None and returns a scalar False instead of a boolean mask.
#     model.img_context_token_id = image_token_id
